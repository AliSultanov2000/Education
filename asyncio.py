...
def gradient_descent(learning_rate: int, eps: int, weights: np.array, max_iter: int): 
    """
    ...
    for iter in range(max_iter):
        ...
        next_weights = cur_weights - learning_rate * gr_mserror_mat(X_train, cur_weights, y_train)

        # Остановка когда достигнута необходимая степень точности
        print(f"Итерация: {iter}")
        print(f"Текущая точка {cur_weights} | Следующая точка {next_weights}")
        print(f"MSE {mserror_mat(X_train, cur_weights, y_train)}")
        print("--------------------------------------------------------")
...
gradient_descent(learning_rate, eps, weights, max_iter)
