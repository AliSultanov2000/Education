...
class YoloDetect:
	"""
	Класс для решения задачи детекции военных объектов на изображении и видеопотоке.
	Работает с Yolo: V5, V6, V7, V8
	"""
	...
	def get_boxes(self, layerOutputs, image):
		"""Функция для получения координат бокса военного объекта"""
		(H, W) = image.shape[:2]
		boxes = []
		confidences = []
		label = []
	...
	def draw_box(self, image, predict, colors):
		"""Функция для отрисовки бокса военного объекта на изображении и видео"""
